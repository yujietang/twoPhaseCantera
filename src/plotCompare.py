...
filename0 = './test_Da.csv'
filename1 = './test_Cl.csv'
# filename1 = './LPT1.csv'
fonts1 = 18
fonts2 = 25
figs = (13,9)
...
ax1.scatter(time, d2/d2[0], label='$Dalton relation$',c ='r',s=15)
ax1.scatter(time_, d2_/d2_[0], label='$Clausius-Clapeyron relation$',c ='g', marker = '^', s=5)
ax1.scatter(time2, value2, label='$OpenFoam$', c = 'k', marker = '+', s=50)
